...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_newton" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#05279835#;
   pragma Export (C, u00001, "newtonB");
